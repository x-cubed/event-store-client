...
Connection.prototype.readAllEventsBackward = function(commitPosition, preparePosition, maxCount, resolveLinkTos, requireMaster, credentials, callback) {
    return this.readAllEvents(Commands.ReadAllEventsBackward, commitPosition, preparePosition, maxCount, resolveLinkTos, requireMaster, credentials, callback);
};

Connection.prototype.readAllEventsForward = function(commitPosition, preparePosition, maxCount, resolveLinkTos, requireMaster, credentials, callback) {
    return this.readAllEvents(Commands.ReadAllEventsForward, commitPosition, preparePosition, maxCount, resolveLinkTos, requireMaster, credentials, callback);
};

Connection.prototype.readAllEvents = function(command, commitPosition, preparePosition, maxCount, resolveLinkTos, requireMaster, credentials, callback) {
    ...
    var correlationId = Connection.createGuid();
    this.sendMessage(correlationId, command, credentials, data, function(pkg) {
        switch (pkg.command) {

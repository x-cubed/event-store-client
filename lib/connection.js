...
function Connection(options) {
    ...
    function receiveMessage(buf) {
        ...
        if (command == Commands.HeartbeatRequest) {
            ...
            instance.sendMessage(Commands.HeartbeatResponse);
...
Connection.prototype.sendPing = function(callback) {
    this.sendMessage(Commands.Ping, null, null, callback);
};
...
Connection.prototype.subscribeToStream = function(streamName, resolveLinkTos, onEventAppeared, onConfirmed, onDropped, credentials) {
    ...
    return this.sendMessage(Commands.SubscribeToStream, credentials, data, function(pkg) {
        switch (pkg.command) {
...
Connection.prototype.createGuid = function() {
    var buffer = new Buffer(GUID_LENGTH);
    uuid.v1({}, buffer);
    return buffer;
};

Connection.prototype.sendMessage = function(command, credentials, data, callback) {
    var correlationId = this.createGuid();
